...
namespace Content.Client.Atmos.UI
{
    ...
    public sealed partial class GasAnalyzerWindow : DefaultWindow
    {
        ...
        public void Populate(GasAnalyzerUserMessage msg)
        {
            ...
            {
                CTopBox.AddChild(new Label { Text = Loc.GetString("gas-analyzer-window-no-data") });
            ...
            if (msg.NodeGasMixes.Length > 1)
            {
                ...
                if (msg.NodeGasMixes.Length == 2)
                {
                    ...
                    MiddlePanelLabel.Text = Loc.GetString(
                        "gas-analyzer-window-tab-title-capitalized",
                        ("title", msg.NodeGasMixes[1].Name)
                    );
                ...
                else if (msg.NodeGasMixes.Length == 3)
                {
                    ...
                    LeftPanelLabel.Text = Loc.GetString(
                        "gas-analyzer-window-tab-title-capitalized",
                        ("title", msg.NodeGasMixes[1].Name)
                    );
                    MiddlePanelLabel.Text = string.Empty;
                    RightPanelLabel.Text = Loc.GetString(
                        "gas-analyzer-window-tab-title-capitalized",
                        ("title", msg.NodeGasMixes[2].Name)
                    );
        ...
        private void GenerateGasDisplay(GasMixEntry gasMix, Control parent)
        {
            ...
            presBox.AddChild(
                ...
                {
                    Text = Loc.GetString(
                        "gas-analyzer-window-pressure-val-text",
                        ("pressure", $"{gasMix.Pressure:0.##}")
                    ),
                    Align = Label.AlignMode.Right,
                    HorizontalExpand = true,
                }
            ...
            if (gasMix.Pressure > Atmospherics.GasMinMoles)
            {
                ...
                tempBox.AddChild(
                    ...
                    {
                        Text = Loc.GetString(
                            "gas-analyzer-window-temperature-val-text",
            ...
            var height = 30;
            var gasBar = new SplitBar { MinHeight = height, MinBarSize = new Vector2(12, 0) };
            // Separator
            ...
            for (var j = 0; j < gasMix.Gases.Length; j++)
            {
                ...
                tablePercent.AddChild(
                    ...
                    {
                        Text = Loc.GetString(
                            "gas-analyzer-window-percentage-text",
                ...
                gasBar.AddEntry(
                    ...
                    tooltip: Loc.GetString(
                        "gas-analyzer-window-molarity-percentage-text",
                        ("gasName", gas.Name),
                        ("amount", $"{gas.Amount:0.##}"),
