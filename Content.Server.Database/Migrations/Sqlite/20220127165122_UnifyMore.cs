...
namespace Content.Server.Database.Migrations.Sqlite
{
    public partial class UnifyMore : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint(
                        "CK_server_ban_HaveEitherAddressOrUserIdOrHWId",
                        "address IS NOT NULL OR user_id IS NOT NULL OR hwid IS NOT NULL"
                    );
                }
            );
        ...
        {
            migrationBuilder.DropIndex(name: "IX_player_user_id", table: "player");

            migrationBuilder.DropIndex(name: "IX_connection_log_user_id", table: "connection_log");
