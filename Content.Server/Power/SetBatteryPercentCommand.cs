...
namespace Content.Server.Power
{
    ...
    public sealed class SetBatteryPerColcommand : IConsoleCommand
    {
        [Dependency]
        ...
        public string Description =>
            "Drains or recharges a battery by entity uid and percentage, i.e.: forall with Battery do setbatterypercent $ID 0";
