...
public sealed partial class CCVars
{
    ...
    /// </remarks>
    public static readonly CVarDef<string> ConfigPresets = CVarDef.Create("config.presets", "", CVar.SERVERONLY);
    ...
    /// </summary>
    public static readonly CVarDef<bool> ConfigPresetDevelopment = CVarDef.Create(
        "config.preset_development",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> ConfigPresetDebug = CVarDef.Create(
        "config.preset_debug",
        true,
        CVar.SERVERONLY
    );
