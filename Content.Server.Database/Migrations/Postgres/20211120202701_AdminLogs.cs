...
namespace Content.Server.Database.Migrations.Postgres
{
    public partial class AdminLogs : Migration
    {
        ...
        {
            migrationBuilder.AddUniqueConstraint(name: "ak_player_user_id", table: "player", column: "user_id");
            ...
            migrationBuilder.CreateIndex(name: "IX_admin_log_type", table: "admin_log", column: "type");
            ...
            migrationBuilder.CreateIndex(name: "IX_player_round_rounds_id", table: "player_round", column: "rounds_id");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "admin_log_player");

            migrationBuilder.DropTable(name: "player_round");

            migrationBuilder.DropTable(name: "admin_log");

            migrationBuilder.DropTable(name: "round");

            migrationBuilder.DropUniqueConstraint(name: "ak_player_user_id", table: "player");
        }
    }
}
