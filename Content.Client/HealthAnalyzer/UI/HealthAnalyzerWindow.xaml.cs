...
namespace Content.Client.HealthAnalyzer.UI
{
    ...
    public sealed partial class HealthAnalyzerWindow : FancyWindow
    {
        ...
        public void Populate(HealthAnalyzerScannedUserMessage msg)
        {
            ...
            name.AddText(
                _entityManager.HasComponent<MetaDataComponent>(_target.Value)
            ...
            var hasHumanoidAppearance = _entityManager.TryGetComponent<HumanoidAppearanceComponent>(
                _target.Value,
            ...
            StatusLabel.Text = _entityManager.TryGetComponent<MobStateComponent>(
                _target.Value,
            ...
            var damageSortedGroups = damageable
                .DamagePerGroup.OrderByDescending(damage => damage.Value)
        ...
        private void DrawMetabolizingChemicals(List<(string ReagentId, FixedPoint2 Quantity)>? reagents)
        {
            ...
            foreach (var reagent in sortedReagents)
            {
                ...
                var quantityLabel = new Label { Text = $"{reagent.Quantity}u", HorizontalAlignment = HAlignment.Right };
        ...
        private BoxContainer CreateDiagnosticGroupTitle(string text, string id)
        {
            ...
            rootContainer.AddChild(
                new TextureRect { SetSize = new Vector2(30, 30), Texture = GetTexture(id.ToLower()) }
            );
