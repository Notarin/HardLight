...
public sealed partial class PirateBountyEntry : BoxContainer
{
    ...
    public PirateBountyEntry(PirateBountyData bounty, TimeSpan untilNextSkip)
    {
        ...
        ManifestLabel.SetMarkup(
            Loc.GetString("pirate-bounty-console-manifest-label", ("item", string.Join(", ", items)))
        );
        RewardLabel.SetMarkup(
            Loc.GetString(
                "pirate-bounty-console-reward-label",
                ("reward", BankSystemExtensions.ToIndependentString(bountyPrototype.Reward))
            )
        );
        DescriptionLabel.SetMarkup(
            Loc.GetString(
                "pirate-bounty-console-description-label",
