...
public sealed class GravityWellSystem : SharedGravityWellSystem
{
    ...
    [Dependency]
    private readonly IViewVariablesManager _vvManager = default!;
    ...
    public override void Initialize()
    {
        ...
        vvHandle.AddPath(
            nameof(GravityWellComponent.TargetPulsePeriod),
    ...
    private bool CanGravPulseAffect(EntityUid entity)
    {
        ...
        return !(_gridQuery.HasComp(entity) || _mapQuery.HasComp(entity) || _wellQuery.HasComp(entity));
    }
