...
public sealed partial class JobWhitelistsWindow : FancyWindow
{
    ...
    private void InitializeTierButtons()
    {
        ...
        {
            var button = new Button { Text = Loc.GetString(tier.Name), Modulate = tier.Color };
    ...
    public void HandleState(JobWhitelistsEuiState state)
    {
        ...
        var ghostRolePanel = new GhostRoleSetWhitelistPanel(
            ghostRoles,
            Loc.GetString("player-panel-ghost-role-whitelists"),
            Color.FromHex("#71f0ca"),
            _proto,
            state.GhostRoleWhitelists
        );
