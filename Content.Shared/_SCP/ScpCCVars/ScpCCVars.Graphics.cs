...
public sealed partial class ScpCCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> GrainToggleOverlay = CVarDef.Create(
        "shader.grain_toggle_overlay",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Mono - false by default

    /// <summary>
    /// Сила шейдера зернистости // Shitty translation, dont take as fact - "The power of the grain shader"
    /// </summary>
    public static readonly CVarDef<int> GrainStrength = CVarDef.Create(
        "shader.grain_strength",
        140,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> LightBloomEnable = CVarDef.Create(
        "scp.light_bloom_enable",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Mono - false by default, keeping it incase anyone actually wants to use this; I personally think it looks really weird.
    ...
    /// </summary>
    public static readonly CVarDef<bool> LightBloomConeEnable = CVarDef.Create(
        "scp.light_bloom_cone_enable",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Mono - false by default
    ...
    /// </summary>
    public static readonly CVarDef<bool> LightBloomOptimizations = CVarDef.Create(
        "scp.light_bloom_optimizations",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Mono - true by default
    ...
    /// </summary>
    public static readonly CVarDef<float> LightBloomStrength = CVarDef.Create(
        "scp.light_bloom_strength",
        0.25f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Mono - change from 0.5
}
