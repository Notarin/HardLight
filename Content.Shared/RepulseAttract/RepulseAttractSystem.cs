...
public sealed class RepulseAttractSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RepulseAttractComponent, MeleeHitEvent>(
            OnMeleeAttempt,
    ...
    private void OnRepulseAttractAction(Entity<RepulseAttractComponent> ent, ref RepulseAttractActionEvent args)
    {
        ...
        args.Handled = TryRepulseAttract(
            position,
            args.Performer,
            ent.Comp.Speed,
            ent.Comp.Range,
    ...
    )
    {
        ...
        {
            if (!_physicsQuery.TryGetComponent(target, out var physics) || (physics.CollisionLayer & (int)layer) != 0x0) // exclude layers like ghosts
                continue;
