...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> ProcgenPreload = CVarDef.Create("procgen.preload", true, CVar.SERVERONLY);
    ...
    /// </summary>
    public static readonly CVarDef<bool> BiomassEasyMode = CVarDef.Create("biomass.easy_mode", true, CVar.SERVERONLY);

    /// <summary>
    ///     A scale factor applied to a grid's bounds when trying to find a spot to randomly generate an anomaly.
    /// </summary>
    public static readonly CVarDef<float> AnomalyGenerationGridBoundsScale = CVarDef.Create(
        "anomaly.generation_grid_bounds_scale",
        0.6f,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<float> AfkTime = CVarDef.Create("afk.time", 60f, CVar.SERVERONLY);

    /// <summary>
    ///     Flavor limit. This is to ensure that having a large mass of flavors in
    ///     some food object won't spam a user with flavors.
    /// </summary>
    public static readonly CVarDef<int> FlavorLimit = CVarDef.Create("flavor.limit", 10, CVar.SERVERONLY);

    public static readonly CVarDef<string> DestinationFile = CVarDef.Create(
    ...
    /// </summary>
    public static readonly CVarDef<bool> ResourceUploadingStoreEnabled = CVarDef.Create(
        "netres.store_enabled",
        false,
        CVar.SERVER | CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> ResourceUploadingStoreDeletionDays = CVarDef.Create(
        "netres.store_deletion_days",
        0,
        CVar.SERVER | CVar.SERVERONLY
    ); // Frontier 30<0
    ...
    /// </summary>
    public static readonly CVarDef<float> UpdateRestartDelay = CVarDef.Create(
        "update.restart_delay",
        20f,
        CVar.SERVERONLY
    );
    ...
    ///     Defaults to true.
    /// </summary>
    public static readonly CVarDef<bool> FireAlarmAllAccess = CVarDef.Create(
        "firealarm.allaccess",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<float> PlayTimeSaveInterval = CVarDef.Create(
        "playtime.save_interval",
        900f,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> GCMaximumTimeMs = CVarDef.Create("entgc.maximum_time_ms", 10, CVar.SERVERONLY); // Frontier: 5<10

    public static readonly CVarDef<bool> GatewayGeneratorEnabled = CVarDef.Create("gateway.generator_enabled", true); // Frontier: false

    public static readonly CVarDef<string> TippyEntity = CVarDef.Create(
        "tippy.entity",
        "NFTippy",
        CVar.SERVER | CVar.REPLICATED
    ); // Frontier: Tippy<NFTippy

    /// <summary>
    ///     The number of seconds that must pass for a single entity to be able to point at something again.
    /// </summary>
    public static readonly CVarDef<float> PointingCooldownSeconds = CVarDef.Create(
        "pointing.cooldown_seconds",
        0.5f,
        CVar.SERVERONLY
    );
}
