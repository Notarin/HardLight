...
namespace Content.Shared.Verbs
{
    public abstract class SharedVerbSystem : EntitySystem
    {
        ...
        )
        {
            ...
            {
                var verbEvent = new GetVerbsEvent<InteractionVerb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            if (types.Contains(typeof(UtilityVerb)) && @using != null && @using != target)
            {
                var verbEvent = new GetVerbsEvent<UtilityVerb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            {
                var verbEvent = new GetVerbsEvent<InnateVerb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            {
                var verbEvent = new GetVerbsEvent<ActivationVerb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            {
                var verbEvent = new GetVerbsEvent<ExamineVerb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            {
                var verbEvent = new GetVerbsEvent<Verb>(
                    user,
                    target,
                    @using,
                    hands,
            ...
            if (types.Contains(typeof(EquipmentVerb)))
            {
                ...
                var verbEvent = new GetVerbsEvent<EquipmentVerb>(
                    user,
                    target,
                    @using,
                    hands,
        ...
        public virtual void ExecuteVerb(Verb verb, EntityUid user, EntityUid target, bool forced = false)
        {
            ...
            if (
                verb.DoContactInteraction
                ?? (verb.DefaultDoContactInteraction && _interactionSystem.InRangeUnobstructed(user, target))
            )
