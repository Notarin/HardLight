...
public sealed partial class AdminOptionsTab : Control
{
    ...
    public AdminOptionsTab()
    {
        ...
        foreach (var format in Enum.GetValues(typeof(AdminOverlayAntagFormat)))
        {
            antagFormats.Add(
                new OptionDropDownCVar<string>.ValueOption(
                    format.ToString()!,
                    Loc.GetString($"ui-options-admin-overlay-antag-format-{format.ToString()!.ToLower()}")
                )
            );
        }
        ...
        {
            antagSymbolStyles.Add(
                new OptionDropDownCVar<string>.ValueOption(
                    symbol.ToString()!,
                    Loc.GetString($"ui-options-admin-overlay-antag-symbol-{symbol.ToString()!.ToLower()}")
                )
            );
        }
        ...
        {
            playerTabColorSettings.Add(
                new OptionDropDownCVar<string>.ValueOption(
                    setting.ToString()!,
                    Loc.GetString($"ui-options-admin-player-tab-color-setting-{setting.ToString()!.ToLower()}")
                )
            );
        }
        ...
        {
            playerTabRoleSettings.Add(
                new OptionDropDownCVar<string>.ValueOption(
                    setting.ToString()!,
                    Loc.GetString($"ui-options-admin-player-tab-role-setting-{setting.ToString()!.ToLower()}")
                )
            );
        }
        ...
        Control.AddOptionDropDown(
            CCVars.AdminPlayerTabSymbolSetting,
            DropDownPlayerTabSymbolSetting,
            playerTabSymbolSettings
        );
        Control.AddOptionDropDown(
            CCVars.AdminPlayerTabRoleSetting,
            DropDownPlayerTabRoleSetting,
            playerTabRoleSettings
        );
        Control.AddOptionDropDown(
            CCVars.AdminPlayerTabColorSetting,
            DropDownPlayerTabColorSetting,
            playerTabColorSettings
        );
