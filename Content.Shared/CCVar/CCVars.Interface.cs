...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<string> UIClickSound = CVarDef.Create(
        "interface.click_sound",
        "/Audio/UserInterface/click.ogg",
        CVar.REPLICATED
    );
    ...
    /// </summary>
    public static readonly CVarDef<string> UIHoverSound = CVarDef.Create(
        "interface.hover_sound",
    ...
    /// </summary>
    public static readonly CVarDef<string> UILayout = CVarDef.Create(
        "ui.layout",
        "Default",
    ...
    /// </summary>
    public static readonly CVarDef<string> DefaultScreenChatSize = CVarDef.Create(
        "ui.default_chat_size",
        "",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<string> SeparatedScreenChatSize = CVarDef.Create(
        "ui.separated_chat_size",
        "0.6,0",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );

    public static readonly CVarDef<bool> OutlineEnabled = CVarDef.Create("outline.enabled", true, CVar.CLIENTONLY);
    ...
    /// </summary>
    public static readonly CVarDef<string> AdminOverlayAntagFormat = CVarDef.Create(
        "ui.admin_overlay_antag_format",
        "Subtype",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AdminOverlayPlaytime = CVarDef.Create(
        "ui.admin_overlay_playtime",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AdminOverlayStartingJob = CVarDef.Create(
        "ui.admin_overlay_starting_job",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<string> AdminPlayerTabSymbolSetting = CVarDef.Create(
        "ui.admin_player_tab_symbols",
        "Specific",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<string> AdminPlayerTabColorSetting = CVarDef.Create(
        "ui.admin_player_tab_color",
        "Both",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// SubtypeRoleType
    /// </summary>
    public static readonly CVarDef<string> AdminPlayerTabRoleSetting = CVarDef.Create(
        "ui.admin_player_tab_role",
        "Subtype",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AdminPlayerlistButtonStyling = CVarDef.Create(
        "ui.admin_playerlist_button_styling",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// Specific: The roletype-specific symbol is shown for anyone marked as antag.
    /// </summary>
    public static readonly CVarDef<string> AdminOverlaySymbolStyle = CVarDef.Create(
        "ui.admin_overlay_symbol_style",
        "Specific",
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> AdminOverlayGhostFadeDistance = CVarDef.Create(
        "ui.admin_overlay_ghost_fade_distance",
        6,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> AdminOverlayGhostHideDistance = CVarDef.Create(
        "ui.admin_overlay_ghost_hide_distance",
        2,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<float> AdminOverlayMergeDistance = CVarDef.Create(
        "ui.admin_overlay_merge_distance",
        0.33f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> AdminOverlayStackMax = CVarDef.Create(
        "ui.admin_overlay_stack_max",
        3,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AdminStripMenuOverlayDefault = CVarDef.Create(
        "ui.admin_strip_menu_overlay_default",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
}
