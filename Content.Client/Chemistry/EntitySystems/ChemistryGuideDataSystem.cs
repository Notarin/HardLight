...
public sealed class ChemistryGuideDataSystem : SharedChemistryGuideDataSystem
{
    ...
    private void OnPrototypesReloaded(PrototypesReloadedEventArgs? ev)
    {
        ...
        foreach (var gas in PrototypeManager.EnumeratePrototypes<GasPrototype>())
        {
            ...
            var data = new ReagentGasSourceData(new() { DefaultCondenseCategory }, gas);
        ...
        foreach (var entProto in PrototypeManager.EnumeratePrototypes<EntityPrototype>())
        {
            ...
            if (
                !entProto.TryGetComponent<ExtractableComponent>(
                    out var extractableComponent,
            ...
            {
                var data = new ReagentEntitySourceData(new() { DefaultJuiceCategory }, entProto, juiceSolution);
            ...
            if (
                extractableComponent.GrindableSolution is { } grindableSolutionId
                && entProto.TryGetComponent<SolutionContainerManagerComponent>(
                    out var manager,
                    EntityManager.ComponentFactory
                )
            ...
            {
                var data = new ReagentEntitySourceData(new() { DefaultGrindCategory }, entProto, grindableSolution);
