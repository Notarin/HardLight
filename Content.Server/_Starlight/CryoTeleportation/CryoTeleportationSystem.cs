...
public sealed class CryoTeleportationSystem : EntitySystem
{
    ...
    private void OnSessionStatus(object? sender, SessionStatusEventArgs args)
    {
        ...
        if (args.NewStatus == SessionStatus.Disconnected && comp.ExitTime == null) // HardLight: Session.Status>NewStatus
            comp.ExitTime = _timing.CurTime;
        else if (args.NewStatus == SessionStatus.Connected && comp.ExitTime != null) // HardLight: Session.Status>NewStatus
            comp.ExitTime = null;
