...
public sealed partial class PlayerTabEntry : PanelContainer
{
    ...
    )
    {
        ...
        CharacterLabel.Text = Loc.GetString(
            "player-tab-character-name-antag-symbol",
            ("symbol", symbol),
        ...
        switch (roleSetting)
        {
            case AdminPlayerTabRoleTypeOption.RoleTypeSubtype:
                RoleTypeLabel.Text = roletype != subtype ? roletype + " - " + subtype : roletype;
                break;
            case AdminPlayerTabRoleTypeOption.SubtypeRoleType:
                RoleTypeLabel.Text = roletype != subtype ? subtype + " - " + roletype : roletype;
                break;
