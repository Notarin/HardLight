...
namespace Content.Client.Access.UI
{
    ...
    public sealed partial class AgentIDCardWindow : DefaultWindow
    {
        ...
        public void SetAllowedIcons(string currentJobIconId)
        {
            ...
            var i = 0;
            var icons = _prototypeManager
                .EnumeratePrototypes<JobIconPrototype>()
                .Where(icon => icon.AllowSelection)
                .ToList();
            icons.Sort(
                (x, y) => string.Compare(x.LocalizedJobName, y.LocalizedJobName, StringComparison.CurrentCulture)
            );
