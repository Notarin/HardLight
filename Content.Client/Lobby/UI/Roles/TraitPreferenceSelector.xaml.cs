...
public sealed partial class TraitPreferenceSelector : Control
{
    ...
    private void UpdateButtonState()
    {
        if (Preference)
        {
            ...
            // Use a distinct highlight color from the Nano stylesheet so selected
            // traits are clearly visible compared to unselected ones.
            TraitButton.ModulateSelfOverride = StyleNano.NanoGold;
        }
        else
        {
