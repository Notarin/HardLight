...
public static class SaveBanStore
{
    ...
    [
        ...
        Entity("CSWeaponVolkiteCulverin", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponVolkiteCaliver", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponVolkiteCharger", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponVolkitePistol", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("volkitePowerPack", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponPistolMk32", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponShotgunEnforcer", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponRifleAssaultLecter", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponRifleAssaultVulcan", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponEnergyRifleCarbine", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponEnergyRifleSniperCannon", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponSubMachineGunWt550", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponEnergySubMachineGunDeltaV", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponRevolverInspector", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdBronze", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdSilver", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdGold", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdSheriff", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdBrigmedic", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdExperimental", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdCombat", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSClothingOuterHardsuitNfsdCommand", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponEnergyRevolver", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSWeaponPistolMk58", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        Entity("CSNFWeaponSubMachineGunDrozd", "Colsec equipment. Destructive to the intended game loop.", new TotalBan()),
        ...
        Component("Currency", "Balance breaking.", new TotalBan()),
        Component("MagicMirror", "unable to be saved.", new TotalBan()),
        Component("EntityTableContainerFill", "Balance breaking.", new TotalBan())
    ];
}
