...
public sealed partial class StationAiCustomizationMenu : FancyWindow
{
    ...
    >? SendStationAiCustomizationMessageAction;
    ...
    public StationAiCustomizationMenu(EntityUid owner)
    {
        ...
        foreach (var groupPrototype in groupPrototypes)
        {
            ...
            _groupContainers[groupPrototype] = new StationAiCustomizationGroupContainer(
                groupPrototype,
                selectedPrototype,
                _buttonGroups[groupPrototype],
                this,
                _protoManager
            );
    ...
    private sealed class StationAiCustomizationEntryContainer : BoxContainer
    {
        ...
        )
        {
            ...
            if (
                !string.IsNullOrEmpty(prototype.PreviewKey)
                && prototype.LayerData.TryGetValue(prototype.PreviewKey, out var layerData)
            )
            {
