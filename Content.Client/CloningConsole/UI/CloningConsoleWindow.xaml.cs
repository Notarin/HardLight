    ...
    public sealed partial class CloningConsoleWindow : DefaultWindow
    {
        ...
        public void Populate(CloningConsoleBoundUserInterfaceState state)
        {
            ...
            if (state.ScannerConnected)
            {
                ...
                ScannerInfoLabel.SetMarkup(
                    state.ScannerBodyInfo != null
                        ? Loc.GetString(
                            "cloning-console-window-scanner-id",
            ...
            if (state.ClonerConnected)
            {
                ...
                ClonerBrainActivity.SetMarkup(
                    Loc.GetString(
                        state.MindPresent
                            ? "cloning-console-mind-present-text"
                            : "cloning-console-no-mind-activity-text"
                    )
                );
                // Set label depending if clonepod is occupied or not
                ClonerInfoLabel.SetMarkup(
                    state.ClonerBodyInfo != null
