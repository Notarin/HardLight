...
{
    [UISystemDependency]
    private readonly GuidebookSystem _guidebookSystem = default!;
    ...
    private void HandleStateEntered(State state)
    {
        ...
        // setup keybinding
        CommandBinds
            .Builder.Bind(ContentKeyFunctions.OpenGuidebook, InputCmdHandler.FromDelegate(_ => ToggleGuidebook()))
