...
public sealed partial class SimpleRadialMenu : RadialMenu
{
    ...
    {
        var button = settings.UseSectors ? ConvertToButtonWithSector(model, settings) : new RadialMenuButton();
        ...
        var imageControl = model.IconSpecifier switch
        {
            ...
            RadialMenuEntityPrototypeIconSpecifier entProtoSpecifier => CreateEntityPrototypeView(
                entProtoSpecifier.ProtoId
            ),
            _ => null,
        };
    ...
    private static Control CreateTexture(SpriteSpecifier spriteSpecifier, SpriteSystem sprites)
    {
        ...
        var imageControl = new TextureRect() { Texture = texture, TextureScale = scale };
        return imageControl;
    }

    private static RadialMenuButtonWithSector ConvertToButtonWithSector(
        RadialMenuOptionBase model,
        SimpleRadialMenuSettings settings
    )
    {
    ...
    private void UpdatePosition()
    {
        ...
        var coords = _entManager
            .System<SpriteSystem>()
            .GetSpriteScreenCoordinates((_attachMenuToEntity.Value, null, xform));
...
public sealed class RadialMenuNestedLayerOption(
    IReadOnlyCollection<RadialMenuOptionBase> nested,
    float containerRadius = 100
