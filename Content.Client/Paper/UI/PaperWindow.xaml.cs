...
namespace Content.Client.Paper.UI
{
    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        public void InitVisuals(EntityUid entity, PaperVisualsComponent visuals)
        {
            ...
            var backgroundImage =
                visuals.BackgroundImagePath != null
            ...
            HeaderImage.Margin = new Thickness(
                visuals.HeaderMargin.Left,
        ...
        protected override void Draw(DrawingHandleScreen handle)
        {
            ...
            if (WrittenTextLabel.TryGetStyleProperty<Font>("font", out var font))
            {
                ...
                var scaleY =
                    (_paperContentLineScale * fontLineHeight) / _paperContentTex.Texture?.Height ?? fontLineHeight;
        ...
        {
            var window = new DefaultWindow { Title = Loc.GetString("Fill form"), Resizable = false };
            ...
            var edit = new LineEdit { MinSize = new Vector2(200, 0) };
