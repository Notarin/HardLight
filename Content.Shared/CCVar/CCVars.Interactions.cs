...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<float> DragDropDeadZone = CVarDef.Create(
        "control.drag_dead_zone",
        12f,
    ...
    /// </summary>
    public static readonly CVarDef<bool> ToggleWalk = CVarDef.Create(
        "control.toggle_walk",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> InteractionRateLimitCount = CVarDef.Create(
        "interaction.rate_limit_count",
        5,
        CVar.SERVER | CVar.REPLICATED
    );

    /// <seealso cref="InteractionRateLimitCount"/>
    public static readonly CVarDef<float> InteractionRateLimitPeriod = CVarDef.Create(
        "interaction.rate_limit_period",
        0.5f,
        CVar.SERVER | CVar.REPLICATED
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> InteractionRateLimitAnnounceAdminsDelay = CVarDef.Create(
        "interaction.rate_limit_announce_admins_delay",
        120,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> StaticStorageUI = CVarDef.Create(
        "control.static_storage_ui",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    ); // Frontier: true<false
    ...
    /// </summary>
    public static readonly CVarDef<bool> OpaqueStorageWindow = CVarDef.Create(
        "control.opaque_storage_background",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> StorageWindowTitle = CVarDef.Create(
        "control.storage_window_title",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> StorageLimit = CVarDef.Create(
    ...
    /// </summary>
    public static readonly CVarDef<bool> NestedStorage = CVarDef.Create(
        "control.nested_storage",
        true,
        CVar.REPLICATED | CVar.SERVER
    );
}
