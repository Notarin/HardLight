...
namespace Content.Shared.Examine
{
    public abstract partial class ExamineSystemShared : EntitySystem
    {
        ...
        [Dependency]
        protected readonly MobStateSystem MobStateSystem = default!;
        ...
        public float GetExaminerRange(EntityUid examiner, MobStateComponent? mobState = null)
        {
            if (Resolve(examiner, ref mobState, logMissing: false))
            {
                ...
                if (
                    MobStateSystem.IsCritical(examiner, mobState)
        ...
        )
        {
            ...
            var wrapped = (EntityUid uid, Ignored? wrapped) => wrapped != null && wrapped(uid);
        ...
        )
        {
            ...
            var rayResults = _occluder.IntersectRayWithPredicate(origin.MapId, ray, length, state, predicate, false);
