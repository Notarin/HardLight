...
public sealed partial class QuickDialogSystem
{
    ...
    )
    {
        OpenDialogInternal(
            session,
            title,
            new List<QuickDialogEntry> { new("1", TypeToEntryType(typeof(T1)), prompt) },
    ...
    [PublicAPI]
    public void OpenDialog<T1, T2, T3>(
        ICommonSession session,
        string title,
        string prompt1,
        string prompt2,
    ...
    [PublicAPI]
    public void OpenDialog<T1, T2, T3, T4>(
        ICommonSession session,
        string title,
        string prompt1,
        string prompt2,
