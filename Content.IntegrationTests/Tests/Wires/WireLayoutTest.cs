    ...
    public async Task TestLayoutInheritance()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(
                    ent1.Comp.WiresList,
                    Has.One.With.Property("Action").InstanceOf<PowerWireAction>(),
                    "1 power wire"
                );
                Assert.That(
                    ent1.Comp.WiresList,
                    Has.One.With.Property("Action").InstanceOf<DoorBoltWireAction>(),
                    "1 door bolt wire"
                );
                ...
                Assert.That(
                    ent2.Comp.WiresList,
                    Has.Exactly(2).With.Property("Action").InstanceOf<PowerWireAction>(),
                    "2 power wire"
                );
                Assert.That(
                    ent2.Comp.WiresList,
