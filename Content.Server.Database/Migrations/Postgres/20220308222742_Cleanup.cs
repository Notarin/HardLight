...
namespace Content.Server.Database.Migrations.Postgres
{
    public partial class Cleanup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_server_role_unban_server_ban_ban_id", table: "server_role_unban");

            migrationBuilder.DropIndex(name: "IX_server_role_unban_ban_id", table: "server_role_unban");

            migrationBuilder.DropIndex(name: "IX_server_role_ban__unban_id", table: "server_role_ban");

            migrationBuilder.DropColumn(name: "unban_id", table: "server_role_ban");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_server_role_ban_address", table: "server_role_ban");

            migrationBuilder.DropIndex(name: "IX_server_role_ban_user_id", table: "server_role_ban");
