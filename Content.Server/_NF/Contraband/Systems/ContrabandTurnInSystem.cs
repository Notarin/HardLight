...
public sealed partial class ContrabandTurnInSystem : SharedContrabandTurnInSystem
{
    ...
    /// </summary>
    private void OnPalletAppraise(
        EntityUid uid,
        ContrabandPalletConsoleComponent component,
        ContrabandPalletAppraiseMessage args
    )
    {
        var player = args.Actor;
    ...
    private void GetPalletGoods(
        EntityUid gridUid,
        ContrabandPalletConsoleComponent console,
    ...
    private void OnPalletSale(
        EntityUid uid,
        ContrabandPalletConsoleComponent component,
        ContrabandPalletSellMessage args
    )
    {
        var player = args.Actor;
