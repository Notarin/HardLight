...
public sealed partial class ConsentSystemCCVars : CVars
{
    ...
    /// </summary>
    public static readonly CVarDef<int> ConsentFreetextMaxLength = CVarDef.Create(
        "consent.freetext_max_length",
        1000,
    ...
    /// </summary>
    public static readonly CVarDef<bool> ConsentNonconColorblindPalette = CVarDef.Create(
        "consent.noncon_colorblind_palette",
        false,
