...
public sealed partial class GroupMembersPopup : DefaultWindow
{
    ...
    public void SetMembers(
        List<NanoChatRecipient> allContacts,
    ...
    private void UpdateMembersList()
    {
        ...
        var memberContacts = _allContacts.Where(c => _members.Contains(c.Number)).OrderBy(c => c.Name).ToList();
        ...
        for (var idx = 0; idx < memberContacts.Count; idx++)
        {
            ...
            var contactControl = new MemberContainer(
                contact,
                isEvenRow,
                isMemberCreator,
                isMemberAdmin,
        ...
        )
        {
            ...
            var nameLabel = new Label
            {
                Text =
                    contact.Name
                    + (
                        isCreator ? $" {Loc.GetString("nano-chat-owner-suffix")}"
                        : isAdmin ? $" {Loc.GetString("nano-chat-admin-suffix")}"
                        : ""
                    ),
