...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> ShipyardSaveVerbose = CVarDef.Create(
    ...
    /// </summary>
    public static readonly CVarDef<bool> ShipyardUseLegacySerializer = CVarDef.Create(
    ...
    /// </summary>
    public static readonly CVarDef<int> ShipyardSaveProgressInterval = CVarDef.Create(
