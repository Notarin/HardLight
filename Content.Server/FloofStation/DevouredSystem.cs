...
// Hardlight - Start
/// <summary>
/// Handles entities while they are inside a vore container, including temporary survival immunities,
/// suit sensor privacy, escape verbs, and movement suppression.
/// </summary>
// Hardlight - End
public sealed class DevouredSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        // Hardlight - Start
        // Immunity removal is deferred by one tick so transfers between vore containers do not briefly remove
        // protection and then re-add it. The set only contains entities that actually left a stomach this tick.
        // Hardlight - End
    ...
    {
        if (IsInVoreContainer(prey) || !TryComp<DevouredComponent>(prey, out var tracker)) // Hardlight
            return;
