...
public sealed partial class CriminalRecordsConsoleWindow : FancyWindow
{
    ...
    public void UpdateState(CriminalRecordsConsoleState state)
    {
        ...
        _access = _player.LocalSession?.AttachedEntity is { } player && _accessReader.IsAllowed(player, Console);
    ...
    private void PopulateRecordListing(Dictionary<uint, string>? listing)
    {
        ...
        var entries = listing
            .Select(i => new ItemList.Item(RecordListing) { Text = i.Value, Metadata = i.Key })
            .ToList();
    ...
    private void PopulateRecordContainer(GeneralStationRecord stationRecord, CriminalRecord criminalRecord)
    {
        ...
        if (criminalRecord.Status != SecurityStatus.None)
        {
            specifier = new SpriteSpecifier.Rsi(
                new ResPath("Interface/Misc/security_icons.rsi"),
                GetStatusIcon(criminalRecord.Status)
            );
        }
        ...
        if (criminalRecord.Reason is { } reason)
        {
            ...
            {
                message = FormattedMessage.FromMarkupOrThrow(
    ...
    private void GetReason(SecurityStatus status)
    {
        ...
        ); // just funny it doesn't actually get used
