...
public sealed class ContentEyeSystem : SharedContentEyeSystem
{
    ...
    )
    {
        ...
        RaisePredictiveEvent(new RequestTargetZoomEvent() { TargetZoom = zoom, IgnoreLimit = ignoreLimit });
    ...
    public override void FrameUpdate(float frameTime)
    {
        ...
        while (
            eyeEntities.MoveNext(
                out var entity,
                out ContentEyeComponent? contentComponent,
                out EyeComponent? eyeComponent
            )
        )
        {
