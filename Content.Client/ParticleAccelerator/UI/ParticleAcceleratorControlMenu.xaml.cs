...
public sealed partial class ParticleAcceleratorControlMenu : FancyWindow
{
    ...
    {
        bool hasAccess = _player.LocalSession?.AttachedEntity is { } player && _accessReader.IsAllowed(player, _entity);
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        DrawValueLabel.SetMarkup(
            Loc.GetString(
                "particle-accelerator-control-menu-draw-value",
                ("watts", $"{watts:##,##0}"),
...
public sealed class PASegmentControl : Control
{
    ...
    protected override void EnteredTree()
    {
        ...
        _rsi = IoCManager
            ...
            .GetResource<RSIResource>($"/Textures/Structures/Power/Generation/PA/{BaseState}.rsi")
            .RSI;
        MinSize = _rsi.Size;
