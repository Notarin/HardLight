...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        )
        {
            ...
            reagentTransferButton.OnPressed += args => OnReagentButtonPressed?.Invoke(args, reagentTransferButton);
        ...
        public void UpdateState(BoundUserInterfaceState state)
        {
            ...
            ValveButton.Text = Loc.GetString(
                castState.ValveOpen ? "chem-master-window-valve-open" : "chem-master-window-valve-closed"
            );
            // Starlight-end
        ...
        )
        {
            ...
            var rowContainer = new BoxContainer
            {
                ...
                {
                    new Label { Text = $"{name}: " },
                    new Label { Text = $"{quantity}u", StyleClasses = { StyleNano.StyleClassLabelSecondaryColor } },
                    // Padding
