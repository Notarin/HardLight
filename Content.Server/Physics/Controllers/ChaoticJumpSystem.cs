...
public sealed class ChaoticJumpSystem : VirtualController
{
    ...
    private void Jump(EntityUid uid, ChaoticJumpComponent component)
    {
        ...
        var rayCastResults = _physics
            .IntersectRay(transform.MapID, ray, range, uid, returnOnFirstHit: false)
            .FirstOrNull();
        ...
        else
        {
            targetPos = new Vector2(
                startPos.X + range * (float)Math.Cos(direction),
