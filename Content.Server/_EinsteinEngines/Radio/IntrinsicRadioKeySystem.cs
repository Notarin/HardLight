...
public sealed class IntrinsicRadioKeySystem : EntitySystem
{
    ...
    private void OnTransmitterChannelsChanged(
        EntityUid uid,
    ...
    private void OnReceiverChannelsChanged(
        EntityUid uid,
    ...
    private void UpdateTransmitterChannels(
        EntityUid uid,
        IntrinsicRadioTransmitterComponent transmitter,
        EncryptionKeyHolderComponent keyHolderComp
    )
    {
    ...
    private void UpdateChannels(
        EntityUid _,
        EncryptionKeyHolderComponent keyHolderComp,
        ref HashSet<string> channels,
        HashSet<string>? intrinsicChannels = null
    )
    {
