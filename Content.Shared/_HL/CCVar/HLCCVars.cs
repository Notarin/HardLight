...
public sealed class HLCCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceEnabled = CVarDef.Create(
        "hardlight.round_persistence.enabled",
        false,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceExpeditions = CVarDef.Create(
        "hardlight.round_persistence.expeditions",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceShuttleRecords = CVarDef.Create(
        "hardlight.round_persistence.shuttle_records",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceStationRecords = CVarDef.Create(
        "hardlight.round_persistence.station_records",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceShipData = CVarDef.Create(
        "hardlight.round_persistence.ship_data",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistencePlayerPayments = CVarDef.Create(
        "hardlight.round_persistence.player_payments",
        true,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> RoundPersistenceMaxRounds = CVarDef.Create(
        "hardlight.round_persistence.max_rounds",
        500,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> RoundPersistenceDebugLogging = CVarDef.Create(
        "hardlight.round_persistence.debug_logging",
        false,
        CVar.SERVERONLY
    );

    // Vending performance controls
    public static readonly CVarDef<bool> VendingLazyRestock = CVarDef.Create(
        "hardlight.vending.lazy_restock",
        true,
        CVar.SERVERONLY
    );

    public static readonly CVarDef<int> VendingRestockBatch = CVarDef.Create(
        "hardlight.vending.restock_batch",
        2,
        CVar.SERVERONLY,
        desc: "Max vending machines to restock per tick."
    );

    public static readonly CVarDef<int> VendingRestockTickMs = CVarDef.Create(
        "hardlight.vending.restock_tick_ms",
        250,
        CVar.SERVERONLY,
        desc: "Interval in ms between vending restock ticks."
    );

    // Exclude vending machines from shuttle save files to avoid load-time spikes
    public static readonly CVarDef<bool> ExcludeVendingInShipSave = CVarDef.Create(
        "hardlight.vending.exclude_in_ship_save",
        true,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<bool> WorldChunkDebugLogs = CVarDef.Create(
        "hardlight.world.debug_chunk_logs",
        false,
        CVar.SERVERONLY,
        desc: "Enable world chunk load/unload debug logs."
    );

    // Ship load performance controls
    public static readonly CVarDef<bool> ShipLoadAsync = CVarDef.Create(
        "hardlight.shipload.async",
        true,
        CVar.SERVERONLY,
        desc: "Load ships asynchronously over multiple ticks."
    );

    public static readonly CVarDef<int> ShipLoadBatchNonContained = CVarDef.Create(
        "hardlight.shipload.batch_noncontained",
        128,
        CVar.SERVERONLY,
        desc: "Max non-contained entities to spawn per tick during ship load."
    );

    public static readonly CVarDef<int> ShipLoadBatchContained = CVarDef.Create(
        "hardlight.shipload.batch_contained",
        128,
        CVar.SERVERONLY,
        desc: "Max contained entities to spawn/insert per tick during ship load."
    );

    public static readonly CVarDef<int> ShipLoadTimeBudgetMs = CVarDef.Create(
        "hardlight.shipload.time_budget_ms",
        8,
        CVar.SERVERONLY,
        desc: "Soft time budget per tick for ship load processing (ms)."
    );

    public static readonly CVarDef<bool> ShipLoadDecals = CVarDef.Create(
        "hardlight.shipload.load_decals",
        false,
        CVar.SERVERONLY,
        desc: "If true, restore decals when loading ships (can be expensive)."
    );

    public static readonly CVarDef<bool> ShipLoadLogProgress = CVarDef.Create(
        "hardlight.shipload.log_progress",
        false,
        CVar.SERVERONLY,
        desc: "Log ship load progress each tick."
    );
    ...
    public static readonly CVarDef<bool> ShipyardPurchaseDockCapEnabled = CVarDef.Create(
        "hardlight.shipyard.purchase_dock_cap_enabled",
        true,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<int> ShipyardPurchaseDockCapShuttle = CVarDef.Create(
        "hardlight.shipyard.purchase_dock_cap_shuttle",
        8,
        CVar.SERVERONLY,
        desc: "Max shuttle-side docks considered during shipyard purchase docking. <= 0 disables the cap on this side."
    );

    public static readonly CVarDef<int> ShipyardPurchaseDockCapGrid = CVarDef.Create(
        "hardlight.shipyard.purchase_dock_cap_grid",
        12,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<bool> EmergencyShuttleDockCapEnabled = CVarDef.Create(
        "hardlight.emergency_shuttle.dock_cap_enabled",
        true,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<int> EmergencyShuttleDockCapShuttle = CVarDef.Create(
        "hardlight.emergency_shuttle.dock_cap_shuttle",
        8,
        CVar.SERVERONLY,
        desc: "Max shuttle-side docks considered during emergency shuttle and escape pod docking. <= 0 disables the cap on this side."
    );

    public static readonly CVarDef<int> EmergencyShuttleDockCapGrid = CVarDef.Create(
        "hardlight.emergency_shuttle.dock_cap_grid",
        12,
        CVar.SERVERONLY,
    ...
    /// </summary>
    public static readonly CVarDef<int> ShipLoadDeferredUseDelayBudget = CVarDef.Create(
        "hardlight.shipload.deferred_usedelay_budget",
        32,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<int> RadarMinRequestMs = CVarDef.Create(
        "hardlight.radar.min_request_ms",
        500,
        CVar.SERVERONLY,
    ...
    public static readonly CVarDef<int> RadarReportCacheTtlMs = CVarDef.Create(
        "hardlight.radar.cache_ttl_ms",
        400,
        CVar.SERVERONLY,
    ...
    /// </summary>
    public static readonly CVarDef<bool> MechGunOutsideMech = CVarDef.Create(
        "mech.gun_outside_mech",
        false,
        CVar.SERVERONLY,
        desc: "If true, allows mech weapons to be used outside of mechs."
    );

    /// <summary>
    /// Starlight: Sends afk players to cryo.
    /// </summary>
    public static readonly CVarDef<bool> CryoTeleportation = CVarDef.Create(
        "game.cryo_teleportation",
        true,
        CVar.SERVERONLY
    );
    ...
    public static readonly CVarDef<float> StumbleChance = CVarDef.Create(
        "hardlight.stumble.chance",
        0.15f,
        CVar.SERVERONLY,
        desc: "Probability [0..1] a partial-leg entity stumbles when its distance threshold is reached. <=0 disables stumbles entirely."
    );

    public static readonly CVarDef<float> StumbleTiles = CVarDef.Create(
        "hardlight.stumble.tiles",
        10f,
        CVar.SERVERONLY,
        desc: "Tiles a partial-leg entity must walk between stumble checks. <=0 uses the per-component default."
    );

    public static readonly CVarDef<float> StumbleKnockdownSeconds = CVarDef.Create(
        "hardlight.stumble.knockdown_seconds",
        2.5f,
        CVar.SERVERONLY,
    ...
    /// </summary>
    public static readonly CVarDef<bool> AutoSpawnColComm = CVarDef.Create(
        "game.autospawn_colcomm",
        true,
        CVar.SERVERONLY
    );
}
