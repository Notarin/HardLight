      ...
      range: 100
        ...
        public async Task NetworkDeviceSendAndReceive()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                deviceNetSystem.QueuePacket(
                    device1,
                    networkComponent2.Address,
                    payload,
                    networkComponent2.ReceiveFrequency.Value
                );
            });
        ...
        public async Task WirelessNetworkDeviceSendAndReceive()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                device2 = entityManager.SpawnEntity(
                    "WirelessNetworkDeviceDummy",
                    new MapCoordinates(new Vector2(0, 50), testMap.MapId)
                );
            ...
            await server.WaitAssertion(() =>
            {
                ...
                payload = new NetworkPayload { ["Wirelesstest"] = 5 };
