...
public sealed class EECCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> JetpackEnableAnywhere = CVarDef.Create(
        "ee.jetpack.enable_anywhere",
        false,
        CVar.REPLICATED
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> JetpackEnableInNoGravity = CVarDef.Create(
        "ee.jetpack.enable_in_no_gravity",
        true,
        CVar.REPLICATED
    );
    ...
    public static readonly CVarDef<bool> DoContestsSystem = CVarDef.Create(
        "ee.contests.do_contests_system",
        true,
    ...
    public static readonly CVarDef<bool> AllowClampOverride = CVarDef.Create(
        "ee.contests.allow_clamp_override",
        true,
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    public static readonly CVarDef<bool> DoStaminaContests = CVarDef.Create(
        "ee.contests.do_stamina_contests",
        true,
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    public static readonly CVarDef<bool> DoHealthContests = CVarDef.Create(
        "ee.contests.do_health_contests",
        true,
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> DoMoodContests = CVarDef.Create(
        "ee.contests.do_mood_contests",
        true,
        CVar.REPLICATED | CVar.SERVER
    );
