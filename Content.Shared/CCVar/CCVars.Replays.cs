...
public sealed partial class CCVars
{
    ...
    ///     false.
    /// </summary>
    public static readonly CVarDef<bool> ReplayRecordAdminChat = CVarDef.Create(
        "replay.record_admin_chat",
        false,
        CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> ReplayAutoRecord = CVarDef.Create(
        "replay.auto_record",
        false,
        CVar.SERVERONLY
    );
    ...
    /// </para>
    /// </remarks>
    public static readonly CVarDef<string> ReplayAutoRecordName = CVarDef.Create(
        "replay.auto_record_name",
    ...
    /// </summary>
    public static readonly CVarDef<string> ReplayAutoRecordTempDir = CVarDef.Create(
        "replay.auto_record_temp_dir",
        "",
        CVar.SERVERONLY
    );
}
