...
public sealed class HLProfilerCCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<bool> EntitySpawnProfilerEnabled = CVarDef.Create(
        "hl.profiler.entity_spawns.enabled",
        false,
    ...
    /// </summary>
    public static readonly CVarDef<float> EntitySpawnProfilerInterval = CVarDef.Create(
        "hl.profiler.entity_spawns.interval",
        10f,
        CVar.SERVERONLY | CVar.ARCHIVE,
    ...
    /// </summary>
    public static readonly CVarDef<int> EntitySpawnProfilerTop = CVarDef.Create(
        "hl.profiler.entity_spawns.top",
        15,
        CVar.SERVERONLY | CVar.ARCHIVE,
