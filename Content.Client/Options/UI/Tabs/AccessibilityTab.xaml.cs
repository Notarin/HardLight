using Content.Shared._DV.CCVars; // Extra Delta-V setting merged into Accessibility tab
...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        Control.AddOptionCheckBox(DCCVars.NoVisionFilters, DisableFiltersCheckBox); // Extra Delta-V setting merged into Accessibility tab
