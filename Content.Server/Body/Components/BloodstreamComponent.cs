...
using Content.Server.Traits; // EE
using Content.Server.Traits.Assorted; // EE
...
{
    [RegisterComponent, Access(typeof(BloodstreamSystem), typeof(ReactionMixerSystem), typeof(BloodDeficiencySystem))] // EE: added typeof(BloodDeficiencySystem)
    public sealed partial class BloodstreamComponent : Component
    {
        ...
        /// <summary>
        ///     EE: How much hunger/thirst is used to regenerate one unit of blood. Set to zero to disable.
