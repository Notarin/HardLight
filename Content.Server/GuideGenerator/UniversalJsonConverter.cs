    ...
    public sealed class UniversalJsonConverter<T> : JsonConverter<T>
    {
        ...
        public override void Write(Utf8JsonWriter writer, T obj, JsonSerializerOptions options)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                if (Attribute.GetCustomAttribute(field, typeof(JsonIgnoreAttribute), true) != null)
                    continue;
                ...
                JsonPropertyNameAttribute? attr = (JsonPropertyNameAttribute?)
                    Attribute.GetCustomAttribute(field, typeof(JsonPropertyNameAttribute), true);
            ...
            foreach (PropertyInfo prop in properties)
            {
                ...
                JsonPropertyNameAttribute? attr = (JsonPropertyNameAttribute?)
                    Attribute.GetCustomAttribute(prop, typeof(JsonPropertyNameAttribute), true);
