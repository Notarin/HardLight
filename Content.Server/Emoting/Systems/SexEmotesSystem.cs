...
public sealed class SexEmotesSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<SexEmotesComponent, ComponentStartup>(OnStartup);
        SubscribeLocalEvent<SexEmotesComponent, EmoteEvent>(OnEmote);
    }

    private void OnStartup(EntityUid uid, SexEmotesComponent component, ComponentStartup args)
    {
    ...
    private void OnEmote(EntityUid uid, SexEmotesComponent component, ref EmoteEvent args)
    {
        if (args.Handled)
            return;
    ...
    private bool TryEmoteHands(EntityUid uid, EmotePrototype emote, SexEmotesComponent component)
    {
