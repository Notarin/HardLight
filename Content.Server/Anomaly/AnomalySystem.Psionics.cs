...
{
    [Dependency]
    private readonly SharedAnomalySystem _sharedAnomaly = default!;

    [Dependency]
    private readonly IRobustRandom _randomp = default!;

    [Dependency]
    private readonly DispelPowerSystem _dispel = default!;
    ...
    private void OnDispelled(EntityUid uid, AnomalyComponent component, DispelledEvent args)
    {
        ...
        _sharedAnomaly.ChangeAnomalyHealth(uid, 0 - _randomp.NextFloat(0.4f, 0.8f), component);
        args.Handled = true;
    }
}
