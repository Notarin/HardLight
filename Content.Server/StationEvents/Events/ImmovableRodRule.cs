...
public sealed class ImmovableRodRule : StationEventSystem<ImmovableRodRuleComponent>
{
    ...
    )
    {
        ...
        if (
            proto.TryGetComponent<ImmovableRodComponent>(out var rod, EntityManager.ComponentFactory)
        ...
        )
        {
            ...
            var spawnCoords = targetCoords
                .ToMap(EntityManager, _transform)
                .Offset(-direction * speed * despawn.Lifetime / 2);
