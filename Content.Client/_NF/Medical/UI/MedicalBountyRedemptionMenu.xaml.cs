        ...
        switch (message.BountyStatus)
        {
            ...
            case MedicalBountyRedemptionStatus.Valid:
                ...
                if (message.PaidToStation)
                    RedeemLabel.Text = Loc.GetString(
                        "medical-bounty-redemption-redeem-label-valid-bounty-to-station",
                        ("amount", BankSystemExtensions.ToSpesoString(message.BountyValue))
                    );
                else
                    RedeemLabel.Text = Loc.GetString(
                        "medical-bounty-redemption-redeem-label-valid-bounty",
                        ("amount", BankSystemExtensions.ToSpesoString(message.BountyValue))
                    );
