...
public sealed partial class ShuttleDockControl : BaseShuttleControl
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        foreach (var grid in _grids)
        {
            ...
            var color = hideColor
                ? Color.White
                : _shuttles.GetIFFColor(grid.Owner, grid.Owner == GridEntity, component: iffComp);
    ...
    public void BuildDocks(EntityUid? shuttle)
    {
        ...
        foreach (var (otherShuttle, docks) in DockState.Docks)
        {
            ...
            foreach (var dock in docks)
            {
                ...
                container.AddChild(new Label() { Text = dock.Name, HorizontalAlignment = HAlignment.Center });
