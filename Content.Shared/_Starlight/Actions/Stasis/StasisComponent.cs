...
public sealed partial class StasisComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public float StasisCooldown = 300f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisBluntHealPerSecond = 2f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisSlashingHealPerSecond = 2f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisPiercingHealPerSecond = 2f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisHeatHealPerSecond = 2f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisColdHealPerSecond = 2f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisBleedHealPerSecond = 1.0f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisAdditionalDamageResistance = 1.5f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritBluntHealPerSecond = 1f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritSlashingHealPerSecond = 1f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritPiercingHealPerSecond = 1f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritHeatHealPerSecond = 1f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritColdHealPerSecond = 1f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritBleedHealPerSecond = 0.5f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisInCritAdditionalDamageResistance = 1.5f;
    ...
    [DataField]
    [AutoNetworkedField]
    public float StasisEnterEffectLifetime = 1.7f;
    ...
    [DataField]
    [AutoNetworkedField]
    public string StasisEnterSound = "/Audio/_Starlight/Misc/alien_teleport.ogg";
    ...
    [DataField]
    [AutoNetworkedField]
    public string StasisExitSound = "/Audio/_Starlight/Misc/alien_teleport.ogg";
