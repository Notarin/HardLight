...
namespace Content.Server.Database.Migrations.Postgres
{
    public partial class ExtraIndices : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "IX_player_last_seen_user_name", table: "player");

            migrationBuilder.DropIndex(name: "IX_admin_rank_flag_flag_admin_rank_id", table: "admin_rank_flag");

            migrationBuilder.DropIndex(name: "IX_admin_flag_flag_admin_id", table: "admin_flag");
        }
    }
}
