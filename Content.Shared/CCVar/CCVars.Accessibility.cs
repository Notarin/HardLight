...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<float> ChatWindowOpacity = CVarDef.Create(
        "accessibility.chat_window_transparency",
        0.85f,
    ...
    /// </summary>
    public static readonly CVarDef<bool> ReducedMotion = CVarDef.Create(
        "accessibility.reduced_motion",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );

    public static readonly CVarDef<bool> ChatEnableColorName = CVarDef.Create(
        "accessibility.enable_color_name",
        true,
        CVar.CLIENTONLY | CVar.ARCHIVE,
    ...
    /// </summary>
    public static readonly CVarDef<float> ScreenShakeIntensity = CVarDef.Create(
        "accessibility.screen_shake_intensity",
        1f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AccessibilityColorblindFriendly = CVarDef.Create(
    ...
    ///     Goes from to 0 (completely transparent) to 1 (completely opaque)
    /// </summary>
    public static readonly CVarDef<float> SpeechBubbleTextOpacity = CVarDef.Create(
        "accessibility.speech_bubble_text_opacity",
        1f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    ///     Goes from to 0 (completely transparent) to 1 (completely opaque)
    /// </summary>
    public static readonly CVarDef<float> SpeechBubbleSpeakerOpacity = CVarDef.Create(
        "accessibility.speech_bubble_speaker_opacity",
        1f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    ///     Goes from to 0 (completely transparent) to 1 (completely opaque)
    /// </summary>
    public static readonly CVarDef<float> SpeechBubbleBackgroundOpacity = CVarDef.Create(
        "accessibility.speech_bubble_background_opacity",
        0.75f,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AccessibilityClientCensorNudity = CVarDef.Create(
        "accessibility.censor_nudity",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> AccessibilityServerCensorNudity = CVarDef.Create(
        "accessibility.server_censor_nudity",
        false,
    ...
    /// </summary>
    public static readonly CVarDef<bool> AccessibilityArachnophobia = CVarDef.Create(
        "accessibility.arachnophobia",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> DisableJobIconAnimation = CVarDef.Create(
        "accessibility.disable_job_icon_animation",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> DisableLanguageIcons = CVarDef.Create(
        "accessibility.disable_language_icons",
        false,
        CVar.CLIENTONLY | CVar.ARCHIVE
    );
    #endregion Starlight
