...
/// <summary>
/// Adds a detailed-examine verb to entities with both a <see cref="BatteryComponent"/>
/// and an <see cref="EmpResistanceComponent"/> that reports the EMP energy budget.
/// </summary>
