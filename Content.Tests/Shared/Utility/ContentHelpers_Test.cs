...
namespace Content.Tests.Shared.Utility
{
    ...
    {
        public static readonly IEnumerable<(double val, double max, int levels, int expected)> TestData = new (
            double,
            double,
            int,
            int
        ...
        public static readonly IEnumerable<(double val, double max, int levels, int expected)> TestNear = new (
            double,
            double,
            int,
            int
