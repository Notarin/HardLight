...
public sealed partial class AnomalyPowerSystem
{
    ...
    /// </summary>
    private void DoElectricityAnomalyEffects(
        EntityUid uid,
    ...
    )
    {
        ...
        if (overcharged)
            ...
            ElectricityPulse(uid, component, args);
    }
    ...
    private void ElectricitySupercrit(EntityUid uid, PsionicComponent component, AnomalyPowerActionEvent args)
    {
        ...
        _emp.EmpPulse(
            ...
            range,
            args.Electricity!.Value.EmpEnergyConsumption,
            args.Electricity!.Value.EmpDisabledDuration
        );
        _lightning.ShootRandomLightnings(
            uid,
            range,
            args.Electricity!.Value.MaxBoltCount * (int)component.CurrentAmplification,
            arcDepth: (int)component.CurrentDampening
        );
    }
    ...
    private void ElectricityPulse(EntityUid uid, PsionicComponent component, AnomalyPowerActionEvent args)
    {
        ...
        int boltCount = (int)
            MathF.Floor(
                MathHelper.Lerp(
                    args.Electricity!.Value.MinBoltCount,
                    args.Electricity!.Value.MaxBoltCount,
