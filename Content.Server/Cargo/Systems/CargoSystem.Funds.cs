...
public sealed partial class CargoSystem
{
    ...
    public void InitializeFunds()
    {
        ...
        _cfg.OnValueChanged(
            CCVars.AllowPrimaryAccountAllocation,
            enabled =>
            {
        ...
        _cfg.OnValueChanged(
            CCVars.AllowPrimaryCutAdjustment,
            enabled =>
            {
    ...
    private void OnWithdrawFunds(Entity<CargoOrderConsoleComponent> ent, ref CargoConsoleWithdrawFundsMessage args)
    {
        ...
        if (args.Account == null)
        {
            ...
            if (!_emag.CheckFlag(ent, EmagType.Interaction))
            {
                var msg = Loc.GetString(
                    "cargo-console-fund-withdraw-broadcast",
                    (
                        "name",
                        tryGetIdentityShortInfoEvent.Title ?? Loc.GetString("cargo-console-fund-transfer-user-unknown")
                    ),
                    ("amount", args.Amount),
        ...
        else
        {
            ...
            {
                var msg = Loc.GetString(
                    "cargo-console-fund-transfer-broadcast",
                    (
                        "name",
                        tryGetIdentityShortInfoEvent.Title ?? Loc.GetString("cargo-console-fund-transfer-user-unknown")
                    ),
    ...
    private void OnSetFundingAllocation(
        Entity<FundingAllocationConsoleComponent> ent,
    ...
    private void OnFundAllocationBuiOpen(
        Entity<FundingAllocationConsoleComponent> ent,
