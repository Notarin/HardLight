...
namespace Content.Client.Administration.UI.Bwoink
{
    ...
    public sealed partial class BwoinkControl : Control
    {
        ...
        public BwoinkControl()
        {
            ...
            AdminOnly.OnToggled += args =>
            {
                PlaySound.Disabled = args.Pressed;
                AdminOnly.Label.FontColorOverride = args.Pressed ? StyleNano.DangerousRedFore : null;
            };
            ...
            bool IsNewPlayer(PlayerInfo info)
            {
                ...
                return (
                    info.OverallPlaytime is null || info.OverallPlaytime < TimeSpan.FromMinutes(newPlayerThreshold)
                );
            }
