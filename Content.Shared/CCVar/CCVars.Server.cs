...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<string> ServerId = CVarDef.Create(
        "server.id",
        "Hardlight",
    ...
    /// </summary>
    public static readonly CVarDef<string> RulesFile = CVarDef.Create(
        "server.rules_file",
        "FrontierRuleset",
        CVar.REPLICATED | CVar.SERVER
    ); // Frontier: Rules
    ...
    /// </summary>
    public static readonly CVarDef<string> DefaultGuide = CVarDef.Create(
        "server.default_guide",
        "NewPlayer",
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    /// </para>
    /// </remarks>
    public static readonly CVarDef<int> ServerUptimeRestartMinutes = CVarDef.Create(
        "server.uptime_restart_minutes",
        4320,
        CVar.SERVERONLY
    );
    ...
    /// </summary>
    public static readonly CVarDef<string> ServerLobbyName = CVarDef.Create(
        "server.lobby_name",
        "",
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    /// </summary>
    public static readonly CVarDef<int> ServerLobbyRightPanelWidth = CVarDef.Create(
        "server.lobby_right_panel_width",
        650,
        CVar.REPLICATED | CVar.SERVER
    );
    ...
    /// </summary>
    public static readonly CVarDef<bool> ForceClientHudVersionWatermark = CVarDef.Create(
        "server.force_client_hud_version_watermark",
        false,
        CVar.REPLICATED | CVar.SERVER
    );
}
