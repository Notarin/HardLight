...
public sealed partial class EncryptionKeySystem : EntitySystem
{
    ...
    {
        component.KeyContainer = _container.EnsureContainer<Container>(
            uid,
            EncryptionKeyHolderComponent.KeyContainerName
        );
        UpdateChannels(uid, component);
    }
