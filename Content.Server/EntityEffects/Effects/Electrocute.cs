...
public sealed partial class Electrocute : EntityEffect
{
    ...
    public override void Effect(EntityEffectBaseArgs args)
    {
        ...
        {
            reagentArgs
                .EntityManager.System<ElectrocutionSystem>()
                .TryDoElectrocution(
                    reagentArgs.TargetEntity,
                    null,
                    Math.Max((reagentArgs.Quantity * ElectrocuteDamageScale).Int(), 1),
        ...
        {
            args.EntityManager.System<ElectrocutionSystem>()
                .TryDoElectrocution(
                    args.TargetEntity,
                    null,
                    Math.Max(ElectrocuteDamageScale, 1),
                    TimeSpan.FromSeconds(ElectrocuteTime),
                    Refresh,
                    ignoreInsulation: true
                );
