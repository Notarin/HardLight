...
public sealed partial class AlertLevelPrototype : IPrototype
{
    ...
    /// </summary>
    [DataField("levels")]
    public Dictionary<string, AlertLevelDetail> Levels = new();
    ...
    public string DefaultLevel { get; private set; } = default!;
}
...
public sealed partial class AlertLevelDetail
{
    ...
    /// </summary>
    [DataField("emergencyLightColor")]
    public Color EmergencyLightColor { get; private set; } = Color.FromHex("#FF4020");

    /// <summary>
    /// Will this alert level force emergency lights on for the station that's active?
    /// </summary>
    [DataField("forceEnableEmergencyLights")]
    public bool ForceEnableEmergencyLights { get; private set; } = false;

    /// <summary>
    /// How long it takes for the shuttle to arrive when called.
    /// </summary>
    [DataField("shuttleTime")]
    public TimeSpan ShuttleTime { get; private set; } = TimeSpan.FromMinutes(5);
}
