...
{
    [Dependency]
    private readonly SuitSensorSystem _sensors = default!;
    ...
    /// </summary>
    private void BroadcastSensorStatus(
        EntityUid uid,
        CrewMonitoringServerComponent? serverComponent = null,
    ...
    private void OnDisconnected(
        ...
        ref DeviceNetServerDisconnectedEvent _
    )
    {
        component.SensorStatus.Clear();
    }
