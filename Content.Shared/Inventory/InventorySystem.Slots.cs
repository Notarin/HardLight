...
public partial class InventorySystem : EntitySystem
{
    ...
    private void InitializeSlots()
    {
        ...
        _vvm.GetTypeHandler<InventoryComponent>().AddHandler(HandleViewVariablesSlots, ListViewVariablesSlots);
    ...
    {
        _vvm.GetTypeHandler<InventoryComponent>().RemoveHandler(HandleViewVariablesSlots, ListViewVariablesSlots);
    }
    ...
    private void OnOpenSlotStorage(OpenSlotStorageNetworkMessage ev, EntitySessionEventArgs args)
    {
        ...
        if (
            TryGetSlotEntity(uid, ev.Slot, out var entityUid)
    ...
    public InventorySlotEnumerator GetSlotEnumerator(
        Entity<InventoryComponent?> entity,
        SlotFlags flags = SlotFlags.All
    )
    {
    ...
    {
        return TryGetSlotEntity(uid, relativePath, out var entity, comp) ? ViewVariablesPath.FromObject(entity) : null;
    }
    ...
    public struct InventorySlotEnumerator
    {
        ...
        public InventorySlotEnumerator(
    ...
    public void DropSlotContents(EntityUid uid, string slotName, InventoryComponent? inventory = null)
    {
        ...
        foreach (var slot in inventory.Slots)
        {
            ...
            if (
                container.ContainedEntity is { } entityUid
