...
public sealed partial class EmojiPickerPopup : DefaultWindow
{
    ...
    private void OnSearchChanged(LineEdit.LineEditEventArgs args)
    {
        ...
        {
            _filteredEmojis = NanoChatEmojis
                .EmojiSpecifiers.Where(kv => kv.Key.Contains(search, StringComparison.OrdinalIgnoreCase))
    ...
    public static Dictionary<string, SpriteSpecifier> GetEmojis() =>
        new Dictionary<string, SpriteSpecifier>(NanoChatEmojis.EmojiSpecifiers);
}
