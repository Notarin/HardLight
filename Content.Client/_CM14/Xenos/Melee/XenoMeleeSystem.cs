        ...
        var moveAnimation = new Animation
        {
            ...
            AnimationTracks =
            {
                new AnimationTrackComponentProperty
                {
                    ...
                    KeyFrames = { new KeyFrame(startOffset, 0), new KeyFrame(endOffset, length) },
                },
            },
        };
        ...
        var fadeOutAnimation = new Animation
        {
            ...
            AnimationTracks =
            {
                new AnimationTrackComponentProperty
                {
                    ...
                    KeyFrames = { new KeyFrame(sprite.Color, 0.05f), new KeyFrame(sprite.Color.WithAlpha(0), length) },
                },
            },
        };
