...
public sealed partial class ApcVisualsComponent : Component
{
    ...
    [ViewVariables(VVAccess.ReadWrite)]
    public string[] ChannelSuffixes = new string[(byte)(2 << (sbyte)ApcChannelState.LogWidth)]
    {
        "auto_off",
        "manual_off",
        "auto_on",
    ...
    {
        Color.FromHex("#d1332e"),
        Color.FromHex("#2e8ad1"),
        Color.FromHex("#3db83b"),
        Color.FromHex("#ffac1c"),
    };
