    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    assigned_user_id_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ban_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    connection_log_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
                    user_id = table.Column<Guid>(nullable: false),
                    user_name = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    player_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
                    user_id = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    preference_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
                    user_id = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    unban_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    profile_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    antag_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    job_id = table.Column<int>(nullable: false).Annotation("Sqlite:Autoincrement", true),
                    profile_id = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(name: "IX_job_profile_id", table: "job", column: "profile_id");
            ...
            migrationBuilder.CreateIndex(name: "IX_profile_preference_id", table: "profile", column: "preference_id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "assigned_user_id");

            migrationBuilder.DropTable(name: "connection_log");

            migrationBuilder.DropTable(name: "job");

            migrationBuilder.DropTable(name: "player");

            migrationBuilder.DropTable(name: "unban");

            migrationBuilder.DropTable(name: "profile");

            migrationBuilder.DropTable(name: "ban");

            migrationBuilder.DropTable(name: "preference");
        }
    }
}
